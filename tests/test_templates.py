...
class TestTemplateEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_get_template_by_id(self, client: AsyncClient, authenticated_user):
    ...
    @pytest.mark.asyncio
    async def test_get_nonexistent_template(self, client: AsyncClient, authenticated_user):
    ...
    @pytest.mark.asyncio
    async def test_create_template_requires_admin(self, client: AsyncClient, authenticated_user):
    ...
    @pytest.mark.asyncio
    async def test_admin_can_create_template(self, client: AsyncClient, admin_user):
    ...
    @pytest.mark.asyncio
    async def test_create_duplicate_template_fails(self, client: AsyncClient, admin_user):
        """Test that creating duplicate template names fails."""
        # This should fail because 'python' template already exists
        template_data = {
            "name": "python",
    ...
    @pytest.mark.asyncio
    async def test_update_template_requires_admin(self, client: AsyncClient, authenticated_user):
    ...
    @pytest.mark.asyncio
    async def test_admin_can_update_template(self, client: AsyncClient, admin_user):
        ...
        templates = list_response.json()
        template_id = templates[0]["id"]
        original_desc = templates[0]["description"]
    ...
    @pytest.mark.asyncio
    async def test_delete_template_requires_admin(self, client: AsyncClient, authenticated_user):
    ...
    @pytest.mark.asyncio
    async def test_admin_can_delete_template(self, client: AsyncClient, admin_user):
    ...
    @pytest.mark.asyncio
    async def test_initialize_templates_requires_admin(self, client: AsyncClient, authenticated_user):
    ...
    @pytest.mark.asyncio
    async def test_admin_can_initialize_templates(self, client: AsyncClient, admin_user):
