...
@pytest.mark.asyncio
async def test_update_template_requires_admin(client: AsyncClient, authenticated_user, admin_user):
...
@pytest.mark.asyncio
async def test_delete_template_requires_admin(client: AsyncClient, authenticated_user, admin_user):
