...
async def update_environment_status():
    ...
    cursor = db.environments.find({"user_id": "c1e89f47-f92c-4dea-91bf-d8cfcc54cf47"})
    ...
    if result.modified_count > 0:
        ...
        print(
            f"🔗 Internal URL: http://{latest_env['service_name']}.{latest_env['namespace']}.svc.cluster.local:8080"
        )
    else:
