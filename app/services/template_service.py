        ...
        default_templates = [
            {
                ...
                "description": "Python development environment with pip, virtualenv, and common packages pre-installed. Includes sudo access for system package installation.",
                ...
                "startup_commands": [
                    "apt-get update",
                    "apt-get install -y sudo curl wget git vim nano build-essential",
                    ...
                    "su - devpocket -c 'pip install flask fastapi uvicorn jupyter pandas numpy requests'",
            ...
            },
            {
                ...
                "description": "Node.js development environment with npm, yarn, and popular packages. Includes sudo access for system package installation.",
                "category": TemplateCategory.PROGRAMMING_LANGUAGE,
                "tags": [
                    "nodejs",
                    "npm",
            ...
            },
            {
                ...
                "startup_commands": [
                    "apt-get update",
                    "apt-get install -y sudo curl wget git vim nano build-essential software-properties-common apt-transport-https ca-certificates gnupg lsb-release",
                    "useradd -m -s /bin/bash devpocket",
                    "echo 'devpocket:devpocket' | chpasswd",
                    "usermod -aG sudo devpocket",
                    "echo 'devpocket ALL=(ALL) NOPASSWD:ALL' >> /etc/sudoers",
