...
from app.models.environment import (
    EnvironmentCreate, EnvironmentInDB, EnvironmentStatus, 
    EnvironmentTemplate, ResourceLimits, WebSocketSession,
    EnvironmentMetrics
)
...
class EnvironmentService:
    ...
    async def create_environment(
        ...
        try:
            ...
            logger.info(f"Environment creation started: {env_data.name} for user {user.username}")
            return environment
    ...
    async def _create_container(self, environment: EnvironmentInDB):
        ...
        try:
            ...
            logger.error(f"Error creating container for environment {environment.id}: {e}")
    ...
    async def get_environment(self, env_id: str, user_id: str) -> Optional[EnvironmentInDB]:
    ...
    async def _delete_container(self, environment: EnvironmentInDB):
        ...
        try:
            ...
            logger.error(f"Error deleting container for environment {environment.id}: {e}")
